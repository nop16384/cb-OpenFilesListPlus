...
//  ############################################################################
void            OpenFilesListPlusSettings:: p0_ctor_01  (OflpOptLog& _opt_log, OflpOptSel& _opt_sel)
{
    //  ........................................................................
...
#ifdef  OFLP_LINUX
//  ----------------------------------------------------------------------------
//  constructor specialized stuff -> linux -> wx-2.8.12
//  ----------------------------------------------------------------------------
#if ( wxMAJOR_VERSION == 2 ) && ( wxMINOR_VERSION == 8 ) && ( wxRELEASE_NUMBER == 12 )
                OpenFilesListPlusSettings:: OpenFilesListPlusSettings(
        wxWindow    *   _parent     ,
        wxPoint         _scr_pos    ,
        wxSize          _scr_size   ,
